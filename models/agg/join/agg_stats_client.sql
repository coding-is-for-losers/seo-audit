...
b.client client,
max(replace(replace(gsc_top_keyword_90d,'(',''),')','')) as gsc_top_keyword_90d,
max(gsc_top_url_for_keyword_90d) as gsc_top_url_for_keyword_90d,
max(replace(replace(semrush_top_keyword_vol,'(',''),')','')) as semrush_top_keyword_vol,
max(replace(replace(semrush_top_keyword_cpc,'(',''),')','')) as semrush_top_keyword_cpc,
